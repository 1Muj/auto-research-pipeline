...
export AUTO_VIDEO_PAPER_REGION_EXTRACTION="${AUTO_VIDEO_PAPER_REGION_EXTRACTION:-1}"
export AUTO_VIDEO_REQUIRE_SOURCE_FIGURES="${AUTO_VIDEO_REQUIRE_SOURCE_FIGURES:-0}"
export AUTO_VIDEO_VISUAL_COMPARE="${AUTO_VIDEO_VISUAL_COMPARE:-1}"
export AUTO_VIDEO_REQUIRE_AUDIO="${AUTO_VIDEO_REQUIRE_AUDIO:-1}"
export AUTO_VIDEO_IMAGES_PER_SLIDE="${AUTO_VIDEO_IMAGES_PER_SLIDE:-2}"
export AUTO_VIDEO_MAX_SUBTITLES_PER_SLIDE="${AUTO_VIDEO_MAX_SUBTITLES_PER_SLIDE:-5}"
export AUTO_VIDEO_HYBRID_3D="${AUTO_VIDEO_HYBRID_3D:-0}"
export AUTO_VIDEO_HYBRID_3D_RATIO="${AUTO_VIDEO_HYBRID_3D_RATIO:-0.30}"
# Keep production renders readable.  Set AUTO_VIDEO_EXPERIMENTAL_3D=1 only
# for a deliberately isolated spatial-staging preview.
export AUTO_VIDEO_EXPERIMENTAL_3D="${AUTO_VIDEO_EXPERIMENTAL_3D:-0}"
...
echo "IMAGE_MODEL=${OPENAI_IMAGE_MODEL:-not_set}"
echo "IMAGES_PER_SLIDE=$AUTO_VIDEO_IMAGES_PER_SLIDE"
echo "PAPER_REGION_EXTRACTION=$AUTO_VIDEO_PAPER_REGION_EXTRACTION"
echo "REQUIRE_SOURCE_FIGURES=$AUTO_VIDEO_REQUIRE_SOURCE_FIGURES"
echo "VISUAL_COMPARE=$AUTO_VIDEO_VISUAL_COMPARE"
echo "REQUIRE_AUDIO=$AUTO_VIDEO_REQUIRE_AUDIO"
echo "HYBRID_3D=$AUTO_VIDEO_HYBRID_3D"
echo "HYBRID_3D_RATIO=$AUTO_VIDEO_HYBRID_3D_RATIO"
echo "EXPERIMENTAL_3D=$AUTO_VIDEO_EXPERIMENTAL_3D"
...
for dependency in "pypdf:pypdf"; do
  module="${dependency%%:*}"
  package="${dependency#*:}"
  if ! "$PYTHON_BIN" -c "import ${module}" >/dev/null 2>&1; then
    echo "Installing missing Python dependency: ${package}"
